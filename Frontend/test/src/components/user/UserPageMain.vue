  ...
  <div class="w-2/5 min-w-[500px] max-w-[500px]">
    ...
    <div class="bg-white rounded-lg shadow-lg px-8 py-10 max-w-xl mx-auto">
      ...
      <label class="relative inline-flex items-center me-5 cursor-pointer">
        ...
        <div
          class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-red-300 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-red-600">
        </div>
