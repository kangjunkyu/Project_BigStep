  ...
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <RouterLink to="/" class="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Bigstep</span>
      </RouterLink>
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
        ...
        <ul
          ...
          <label class="relative inline-flex items-center cursor-pointer">
            <input type="checkbox" class="sr-only peer" v-model="isDark" @change="darkToggle">
            <div
            ...
            <span v-if="!isDark" class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Dark Mode</span>
            <span v-else class="ms-3 text-sm font-medium text-gray-900 dark:text-white">Light Mode</span>
          </label>
