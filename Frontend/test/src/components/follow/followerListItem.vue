<template>
  <div
      class="border min-w-[400px] bg-card text-card-foreground rounded-lg overflow-hidden shadow-lg max-w-sm hover:shadow-xl transition-all duration-200"
      data-v0-t="card">
  
      <div class="p-4">
        <h2 class="text-2xl font-bold hover:text-gray-700 transition-all duration-200">{{ follower.name }}</h2>
        <h3 class="text-gray-500 hover:text-gray-600 transition-all duration-200">{{ follower.nickname }}</h3>
